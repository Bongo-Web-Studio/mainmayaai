...
export default function New1() {
  ...
  useEffect(() => {
    ...
    return () => {
      if ((animation as any).scrollTrigger)
      ...
      <div className="w-full max-w-4xl text-center" ref={containerRef}>
        <div className=" flex items-center justify-center">
          <div className="flex items-center w-full lg:max-w-[18cm]  lg:ml-36">
            <div
              className="lg:flex justify-start items-start  rounded-lg w-full  "
              ref={topBlockRef}
            >
              <h3 className="text-2xl lg:text-4xl font-semibold text-[#151515] text-start w-[50%]  ml-16 lg:mx-0">
                <h1 className="text-start  text-[#948E89] italic mt-">
                  then ,
                </h1>
                <h1
                  className="mt-4  w-[8cm] lg:w-auto
                "
                >
                  Maya will <span className="text-[#F54A00] italic">find</span>{" "}
                  the  <br /> right folks{" "}
                  <span className="text-[#F54A00] italic">& talk</span> to  <br /> them
                  on your behalf
                </h1>
              </h3>
        ...
        <div
          className="mt-[1cm] w-full flex justify-center items-center"
          ref={arrowRef}
        >
            ...
            >
              <h3 className="text-2xl lg:text-4xl font-semibold text-[#151515] text-start w-[50%]  ml-16 lg:mx-0">
                <h1 className="mt-20 w-[8cm] lg:w-auto">
                  ...
                  the budget, timeline, availability, <br /> past exp & intent
                </h1>
              </h3>
